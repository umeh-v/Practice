...
with mlflow.start_run():
    ...
    # Load the saved LabelEncoder and transform numerical predictions back to labels
    label_encoder = joblib.load('label_encoder.pkl')
    y_val_pred_labels = label_encoder.inverse_transform(y_val_pred)
    val_report = classification_report(y_val, y_val_pred_labels, output_dict=True)
